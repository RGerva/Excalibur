...
public class ExcaliburItems {
    ...
    public static final RegistryObject<Item> ZIRCON = ITEMS.register("zircon",
            () -> new Item(new Item.Properties()));
    public static final RegistryObject<Item> MYTHRIL = ITEMS.register("mythril_ingot",
            () -> new Item(new Item.Properties()));
    ...
    //NUGGUET
    public static final RegistryObject<Item> MYTHRIL_NUGGUET = ITEMS.register("mythril_nugget",
            () -> new Item(new Item.Properties()));
