...
import com.excaliburmod.excalibur_mod.block.entity.GemInfusingStationBlockEntity;
...
public class GemInfusingStationMenu extends AbstractContainerMenu {
    ...
    public GemInfusingStationMenu(int id, Inventory inv, BlockEntity entity, ContainerData data) {
        super(ExcaliburMenuTypes.GEM_INFUSING_STATION_MENU.get(), id);
    ...
    public boolean stillValid(Player player) {
        return stillValid(ContainerLevelAccess.create(level, blockEntity.getBlockPos()),
                player, ExcaliburBlocks.GEM_INFUSING_STATION.get());
    }
