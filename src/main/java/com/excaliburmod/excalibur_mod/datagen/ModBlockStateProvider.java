...
public class ModBlockStateProvider extends BlockStateProvider {
    ...
    protected void registerStatesAndModels() {
        ...
        blockWithItem(ExcaliburBlocks.MYTHRIL_BLOCK);
        blockWithItem(ExcaliburBlocks.RAW_MYTHRIL_BLOCK);
        ...
        blockWithItem(ExcaliburBlocks.MYTHRIL_ORE);
        blockWithItem(ExcaliburBlocks.DEEPSLATE_MYTHRIL_ORE);
