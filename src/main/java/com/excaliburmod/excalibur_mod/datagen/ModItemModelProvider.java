...
public class ModItemModelProvider extends ItemModelProvider {
    ...
    public ModItemModelProvider(PackOutput output, ExistingFileHelper existingFileHelper) {
        super(output, Excalibur_Mod.MOD_ID, existingFileHelper);
    }
    ...
    protected void registerModels() {
        ...
        simpleItem(ExcaliburItems.MYTHRIL);

        simpleItem(ExcaliburItems.RAW_SAPPHIRE);
        simpleItem(ExcaliburItems.RAW_RUBY);
        simpleItem(ExcaliburItems.RAW_ZIRCON);
        simpleItem(ExcaliburItems.RAW_MYTHRIL);

        simpleItem(ExcaliburItems.MYTHRIL_NUGGUET);
        ...
        trimmedArmorItem(ExcaliburItems.MYTHRIL_HELMET);
        trimmedArmorItem(ExcaliburItems.MYTHRIL_CHESTPLATE);
        trimmedArmorItem(ExcaliburItems.MYTHRIL_LEGGINGS);
        trimmedArmorItem(ExcaliburItems.MYTHRIL_BOOTS);
    ...
    private ItemModelBuilder simpleItem(RegistryObject<Item> item){
        return withExistingParent(item.getId().getPath(),
                ...
                new ResourceLocation(Excalibur_Mod.MOD_ID, "item/" + item.getId().getPath()));
    }
    ...
    private ItemModelBuilder simpleBlockItemBlockTexture(RegistryObject<Block> item) {
        return withExistingParent(item.getId().getPath(),
                new ResourceLocation("item/generated")).texture("layer0",
                new ResourceLocation(Excalibur_Mod.MOD_ID,"block/" + item.getId().getPath()));
    }

    public void evenSimplerBlockItem(RegistryObject<Block> block) {
        this.withExistingParent(Excalibur_Mod.MOD_ID + ":" + ForgeRegistries.BLOCKS.getKey(block.get()).getPath(),
    ...
    public void fenceItem(RegistryObject<Block> block, RegistryObject<Block> baseBlock) {
        this.withExistingParent(ForgeRegistries.BLOCKS.getKey(block.get()).getPath(), mcLoc("block/fence_inventory"))
                .texture("texture",  new ResourceLocation(Excalibur_Mod.MOD_ID, "block/" + ForgeRegistries.BLOCKS.getKey(baseBlock.get()).getPath()));
    }
    ...
    public void wallItem(RegistryObject<Block> block, RegistryObject<Block> baseBlock) {
        this.withExistingParent(ForgeRegistries.BLOCKS.getKey(block.get()).getPath(), mcLoc("block/wall_inventory"))
                .texture("wall",  new ResourceLocation(Excalibur_Mod.MOD_ID, "block/" + ForgeRegistries.BLOCKS.getKey(baseBlock.get()).getPath()));
    }

    //ARMOR ONLY DO NOT TOUCH
    private void trimmedArmorItem(RegistryObject<Item> itemRegistryObject) {
        final String MOD_ID = Excalibur_Mod.MOD_ID; // Change this to your mod id
