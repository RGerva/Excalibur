package net.banze.excalibur;

import com.mojang.logging.LogUtils;
import net.banze.excalibur.block.ModBlocks;
import net.banze.excalibur.creative.ModCreativeModeTabs;
...
@Mod(ExcaliburMod.MOD_ID)
public class ExcaliburMod
{
    // Define mod id in a common place for everything to reference
    public static final String MOD_ID = "excalibur";
